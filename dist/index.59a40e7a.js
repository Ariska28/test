...
parcelHelpers.export(exports, "stopScrollBody", ()=>stopScrollBody);
parcelHelpers.export(exports, "addCustomCursor", ()=>addCustomCursor);
...
function addCustomCursor(elemens) {
    elemens.forEach((el)=>{
    ...
    new (0, _cursor.Cursor)();
}
document.querySelector("[open-menu-btn]").addEventListener("click", ()=>{
    stopScrollBody();
});
if (window.matchMedia("(min-width: 1024px)").matches) {
    (0, _gsapAnimation.appearElemntsByOrder)();
    (0, _gsapAnimation.createCircleAnimation)();
    (0, _gsapAnimation.createCardsAnimation)();
    addCustomCursor(elemensForCursor);
}

},{"./cursor":"3v1v0","./gsapAnimation":"8FhUl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3v1v0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"8FhUl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "appearElemntsByOrder", ()=>appearElemntsByOrder);
parcelHelpers.export(exports, "createCircleAnimation", ()=>createCircleAnimation);
parcelHelpers.export(exports, "createCardsAnimation", ()=>createCardsAnimation);
...
function appearElemntsByOrder() {
    ...
    tl.from("[data-header-logo]", headerEffects).from("[data-header-nav1]", headerEffects).from("[data-header-nav2]", headerEffects).from("[data-header-registration]", headerEffects).from("[data-header-language]", headerEffects).from("[data-text-appear]", {
        ...
        ease: "power3.out",
        stagger: 0.1
    }).from("[data-animation-grow]", {
        scaleX: 0,
        scaleY: 0,
        duration: 1.5
    }, "<").to("[data-animation-top]", {
        y: 10,
        duration: 1
    }).timeScale(1.6).from("[animation-card-container]", {
        opacity: 0,
        duration: 1
    });
}
function createCircleAnimation() {
    (0, _gsap.gsap).to("[data-animation-circle]", {
        scrollTrigger: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9EN09","8lRBv"], "8lRBv", "parcelRequire716c")
